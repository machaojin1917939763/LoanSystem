  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          国家开发银行，生源地助学贷款学生在线登录
          <br />
          <el-link
            href="https://sls.cdb.com.cn/#/"
            type="primary"
            target="_blank"
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h1>生源地贷款管理系统</h1>
        <p>
          该系统用于高校统计学生生源地贷款情况，学生通过此系统上传生源地贷款校验码、合同等，学校可以统计学生在校期间的生源地贷款情况，以及计算生源地贷款余额，下款时间、管理学生个人信息，贷款（成功失败）提醒，还款提醒，逾期提醒，个人征信系统，毕业确认申请等功能。
        </p>
        <p>
          <b>更新日期</b> <span>{{ date }}</span>
        </p>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('http://localhost:81/system/user')"
            >访问管理端</el-button
          >
          <el-button
            size="mini"
